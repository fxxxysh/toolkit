...
namespace Iocomp.Design
{
	...
	[ToolboxItem(false)]
	public class PlotChannelCandlestick1EditorPlugIn : PlugInStandard
	{
		...
		public PlotChannelCandlestick1EditorPlugIn()
		{
		...
		{
			base.AddSubPlugIn(new PlotChannelCandlestick1SpecificEditorPlugIn(), "Candlestick-1", false);
			base.AddSubPlugIn(new PlotFillEditorPlugIn(), "Fill Body-Bearish", false);
			base.AddSubPlugIn(new PlotFillEditorPlugIn(), "Fill Body-Bullish", false);
			base.AddSubPlugIn(new PlotFillEditorPlugIn(), "Fill Shadow", false);
		}

		public override void SetSubPlugInsValue()
		{
			base.SubPlugIns[0].Value = base.Value;
			base.SubPlugIns[1].Value = (base.Value as PlotChannelCandlestick1).FillBodyBearish;
			base.SubPlugIns[2].Value = (base.Value as PlotChannelCandlestick1).FillBodyBullish;
			base.SubPlugIns[3].Value = (base.Value as PlotChannelCandlestick1).FillShadow;
		}
	}
}
