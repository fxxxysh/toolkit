...
namespace Iocomp.Design
{
	...
	public class PlotChannelFillEditorPlugIn : PlugInStandard
	{
		...
		private void InitializeComponent()
		{
			...
			this.focusLabel7.FocusControl = this.LegendNameTextBox;
			this.focusLabel7.Location = new Point(20, 194);
			this.focusLabel7.Name = "focusLabel7";
			this.focusLabel7.Size = new Size(76, 15);
			this.focusLabel7.Text = "Legend Name";
			...
			this.focusLabel6.FocusControl = this.ClippingStyleComboBox;
			this.focusLabel6.Location = new Point(253, 226);
			this.focusLabel6.Name = "focusLabel6";
			this.focusLabel6.Size = new Size(75, 15);
			this.focusLabel6.Text = "Clipping Style";
			...
			this.OPCXValueSourceComboBox.TabIndex = 20;
