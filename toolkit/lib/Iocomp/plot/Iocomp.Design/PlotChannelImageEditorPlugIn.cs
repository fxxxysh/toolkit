...
namespace Iocomp.Design
{
	...
	public class PlotChannelImageEditorPlugIn : PlugInStandard
	{
		...
		private void InitializeComponent()
		{
			...
			this.CapacityTextBox.Location = new Point(96, 80);
			...
			this.focusLabel3.Location = new Point(46, 82);
			...
			this.SendXAxisTrackingDataCheckBox.TabIndex = 4;
			...
			this.SendYAxisTrackingDataCheckBox.TabIndex = 6;
			...
			this.LegendNameTextBox.TabIndex = 7;
			...
			this.LayerNumericUpDown.TabIndex = 9;
			...
			this.ClippingStyleComboBox.TabIndex = 10;
