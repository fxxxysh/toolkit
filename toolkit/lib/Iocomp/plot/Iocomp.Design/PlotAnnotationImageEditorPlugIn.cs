...
namespace Iocomp.Design
{
	...
	public class PlotAnnotationImageEditorPlugIn : PlugInStandard
	{
		...
		private void InitializeComponent()
		{
			...
			this.checkBox1.Location = new Point(304, 176);
			this.checkBox1.Name = "checkBox1";
			this.checkBox1.PropertyName = "FixedSize";
			this.checkBox1.Size = new Size(88, 24);
			...
			this.ImageIndexUpDown.Location = new Point(232, 176);
			...
			this.ImageIndexUpDown.TabIndex = 13;
			this.ImageIndexUpDown.TextAlign = HorizontalAlignment.Center;
			this.focusLabel2.LoadingBegin();
			this.focusLabel2.FocusControl = this.ImageIndexUpDown;
			this.focusLabel2.Location = new Point(164, 177);
			this.focusLabel2.Name = "focusLabel2";
			this.focusLabel2.Size = new Size(68, 15);
			this.focusLabel2.Text = "Image Index";
