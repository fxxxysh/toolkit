...
namespace Iocomp.Design
{
	...
	public class PlotChannelCandlestick3EditorPlugIn : PlugInStandard
	{
		...
		public PlotChannelCandlestick3EditorPlugIn()
		{
		...
		{
			base.AddSubPlugIn(new PlotChannelCandlestick3DataPointsEditorPlugIn(), "Data-Points", false);
			base.AddSubPlugIn(new PlotChannelCandlestick3SpecificEditorPlugIn(), "Candlestick-3", false);
			base.AddSubPlugIn(new PlotFillEditorPlugIn(), "Fill Min-Max", false);
			base.AddSubPlugIn(new PlotFillEditorPlugIn(), "Fill Std-Dev", false);
			base.AddSubPlugIn(new PlotFillEditorPlugIn(), "Fill Mean", false);
		}
		...
		public override void SetSubPlugInsValue()
		{
			...
			base.SubPlugIns[2].Value = (base.Value as PlotChannelCandlestick3).FillMinMax;
			base.SubPlugIns[3].Value = (base.Value as PlotChannelCandlestick3).FillStdDev;
			base.SubPlugIns[4].Value = (base.Value as PlotChannelCandlestick3).FillMean;
		}
	}
}
