...
namespace Iocomp.Design
{
	...
	public class PlotAnnotationPieEditorPlugIn : PlugInStandard
	{
		...
		private void InitializeComponent()
		{
			...
			this.SweepAngleTextBox.Location = new Point(232, 176);
			...
			this.StartAngleTextBox.Location = new Point(232, 152);
			...
			this.focusLabel8.Location = new Point(157, 114);
