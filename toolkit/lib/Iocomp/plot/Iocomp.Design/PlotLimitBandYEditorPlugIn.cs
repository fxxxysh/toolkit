...
namespace Iocomp.Design
{
	...
	public class PlotLimitBandYEditorPlugIn : PlugInStandard
	{
		...
		private void InitializeComponent()
		{
			...
			this.YStartTextBox = new EditBox();
			...
			this.YStartTextBox.LoadingBegin();
			this.YStartTextBox.Location = new Point(80, 72);
			this.YStartTextBox.Name = "YStartTextBox";
			this.YStartTextBox.PropertyName = "YStart";
			this.YStartTextBox.Size = new Size(144, 20);
			this.YStartTextBox.TabIndex = 2;
			this.YStartTextBox.LoadingEnd();
			this.XReferenceLabel.LoadingBegin();
			this.XReferenceLabel.FocusControl = this.YStartTextBox;
			...
			this.XReferenceLabel.Text = "Y-Start";
			...
			this.YStopTextBox.LoadingBegin();
			this.YStopTextBox.Location = new Point(80, 96);
			this.YStopTextBox.Name = "YStopTextBox";
			this.YStopTextBox.PropertyName = "YStop";
			this.YStopTextBox.Size = new Size(144, 20);
			this.YStopTextBox.TabIndex = 3;
			this.YStopTextBox.LoadingEnd();
			this.focusLabel3.LoadingBegin();
			this.focusLabel3.FocusControl = this.YStopTextBox;
			this.focusLabel3.Location = new Point(39, 98);
			this.focusLabel3.Name = "focusLabel3";
			this.focusLabel3.Size = new Size(41, 15);
			this.focusLabel3.Text = "Y-Stop";
			...
			base.Controls.Add(this.YStopTextBox);
			...
			base.Controls.Add(this.YStartTextBox);
