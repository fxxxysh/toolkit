...
namespace Iocomp.Design
{
	...
	public class PlotChannelBiFillEditorPlugIn : PlugInStandard
	{
		...
		private void InitializeComponent()
		{
			...
			this.VisibleInLegendCheckBox.TabIndex = 16;
			...
			this.ColorPicker.Size = new Size(48, 20);
			...
			this.ContextMenuEnabledCheckBox.TabIndex = 17;
			...
			this.UserCanEditCheckBox.TabIndex = 15;
			...
			this.CanFocusCheckBox.TabIndex = 18;
			...
			this.OPCXValueSourceComboBox.TabIndex = 19;
			...
			this.MarkersTurnOffLimitTextBox.TabIndex = 12;
