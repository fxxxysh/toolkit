...
namespace Iocomp.Design
{
	...
	public class PlotChannelTraceEditorPlugIn : PlugInStandard
	{
		...
		private void InitializeComponent()
		{
			...
			this.DrawAntiAliasCheckBox = new Iocomp.Design.Plugin.EditorControls.CheckBox();
			...
			this.VisibleInLegendCheckBox.TabIndex = 17;
			...
			this.EnabledCheckBox.TabIndex = 15;
			...
			this.ContextMenuEnabledCheckBox.TabIndex = 18;
			...
			this.ReferenceTextBox.Location = new Point(328, 192);
			this.ReferenceTextBox.Name = "ReferenceTextBox";
			this.ReferenceTextBox.PropertyName = "Reference";
			this.ReferenceTextBox.Size = new Size(56, 20);
			this.ReferenceTextBox.TabIndex = 9;
			this.ReferenceTextBox.LoadingEnd();
			this.focusLabel10.LoadingBegin();
			this.focusLabel10.FocusControl = this.ReferenceTextBox;
			this.focusLabel10.Location = new Point(270, 194);
			this.focusLabel10.Name = "focusLabel10";
			this.focusLabel10.Size = new Size(58, 15);
			this.focusLabel10.Text = "Reference";
			...
			this.CanFocusCheckBox.TabIndex = 19;
			...
			this.OPCXValueSourceComboBox.TabIndex = 21;
			this.focusLabel8.LoadingBegin();
			this.focusLabel8.FocusControl = this.OPCXValueSourceComboBox;
			this.focusLabel8.Location = new Point(258, 102);
			this.focusLabel8.Name = "focusLabel8";
			this.focusLabel8.Size = new Size(110, 15);
			this.focusLabel8.Text = "OPC X-Value Source";
			this.focusLabel8.LoadingEnd();
			this.DrawAntiAliasCheckBox.Location = new Point(520, 3);
			this.DrawAntiAliasCheckBox.Name = "DrawAntiAliasCheckBox";
			this.DrawAntiAliasCheckBox.PropertyName = "DrawAntiAlias";
			this.DrawAntiAliasCheckBox.TabIndex = 20;
			this.DrawAntiAliasCheckBox.Text = "Draw Anti-Alias";
			...
			this.MarkersTurnOffLimitTextBox.TabIndex = 13;
			...
			base.Controls.Add(this.DrawAntiAliasCheckBox);
