...
namespace Iocomp.Classes
{
	public class EvaluationForm : Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.label2.Text = "Copyright © 1998-2016 Iocomp Software Inc.";
			...
			this.HomeLinkLabel.Size = new Size(93, 16);
			this.HomeLinkLabel.TabIndex = 3;
			this.HomeLinkLabel.TabStop = true;
			this.HomeLinkLabel.Text = "www.iocomp.com";
			...
			this.label1.Text = "Warning: This computer program is protected by copyright law and international treaties. Unauthorized reproduction or distribution of this program, or any portion of it, may result in severe civil and criminal penalties, and will be prosecuted to the maximum extent possible under law.\r\n";
			this.label4.AutoSize = true;
			this.label4.Location = new Point(216, 8);
			...
			this.label5.Location = new Point(208, 32);
			...
			this.SalesLinkLabel.Size = new Size(123, 16);
			this.SalesLinkLabel.TabIndex = 14;
			this.SalesLinkLabel.TabStop = true;
			this.SalesLinkLabel.Text = "www.iocomp.com/order";
			this.SalesLinkLabel.LinkClicked += this.SalesLinkLabel1_LinkClicked;
			...
			this.label7.Size = new Size(384, 3);
