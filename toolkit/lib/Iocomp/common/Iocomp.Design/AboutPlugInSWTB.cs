...
namespace Iocomp.Design
{
	...
	public class AboutPlugInSWTB : PlugInStandard
	{
		...
		private void InitializeComponent()
		{
			...
			this.VersionLabel = new FocusLabel();
			this.CopyrightLabel = new FocusLabel();
			this.ServicePackLabel = new FocusLabel();
			...
			this.LicenseAgreementLabel.Size = new Size(102, 15);
			this.LicenseAgreementLabel.Text = "License Agreement";
			this.LicenseAgreementLabel.LoadingEnd();
			this.VersionLabel.LoadingBegin();
			this.VersionLabel.AutoSize = false;
			this.VersionLabel.FocusControlAlignment = AlignmentQuadSide.Top;
			this.VersionLabel.Location = new Point(218, 5);
			this.VersionLabel.Name = "VersionLabel";
			this.VersionLabel.Size = new Size(50, 18);
			this.VersionLabel.Text = "Version 3";
			this.VersionLabel.LoadingEnd();
			this.CopyrightLabel.LoadingBegin();
			this.CopyrightLabel.AutoSize = false;
			this.CopyrightLabel.Location = new Point(216, 38);
			this.CopyrightLabel.Name = "CopyrightLabel";
			this.CopyrightLabel.Size = new Size(212, 14);
			this.CopyrightLabel.Text = "Copyright 1998-2006 Iocomp Software Inc.";
			this.CopyrightLabel.LoadingEnd();
			this.ServicePackLabel.LoadingBegin();
			this.ServicePackLabel.FocusControlAlignment = AlignmentQuadSide.Top;
			this.ServicePackLabel.Location = new Point(222, 22);
			this.ServicePackLabel.Name = "ServicePackLabel";
			this.ServicePackLabel.Size = new Size(81, 15);
			this.ServicePackLabel.Text = "Service Pack 2";
			this.ServicePackLabel.LoadingEnd();
			...
			this.LogoPictureBox.Location = new Point(9, 9);
			this.LogoPictureBox.Name = "LogoPictureBox";
			this.LogoPictureBox.Size = new Size(167, 55);
			this.LogoPictureBox.SizeMode = PictureBoxSizeMode.StretchImage;
			this.LogoPictureBox.TabIndex = 5;
			this.LogoPictureBox.TabStop = false;
			this.imageList1.ImageSize = new Size(169, 58);
			this.imageList1.ImageStream = (ImageListStreamer)resourceManager.GetObject("imageList1.ImageStream");
			this.imageList1.TransparentColor = Color.White;
			this.WebsiteLabel.AutoSize = true;
			this.WebsiteLabel.Location = new Point(216, 53);
			this.WebsiteLabel.Name = "WebsiteLabel";
			this.WebsiteLabel.Size = new Size(184, 16);
			this.WebsiteLabel.TabIndex = 0;
			this.WebsiteLabel.TabStop = true;
			this.WebsiteLabel.Text = "http://www.instrumentationopc.com/";
		...
		{
			int num = (int)((double)this.VersionLabel.Height * 0.1);
			this.LogoPictureBox.Location = new Point(0, 5);
			this.VersionLabel.Location = new Point(this.LogoPictureBox.Right + 10, 2);
			this.ServicePackLabel.Location = new Point(this.LogoPictureBox.Right + 10, this.VersionLabel.Bottom + num);
			this.CopyrightLabel.Location = new Point(this.LogoPictureBox.Right + 10, this.ServicePackLabel.Bottom + num);
			this.WebsiteLabel.Location = new Point(this.LogoPictureBox.Right + 10, this.CopyrightLabel.Bottom + num);
			this.LicenseAgreementTextBox.Location = new Point(0, this.LogoPictureBox.Bottom + this.LicenseAgreementLabel.Height + 2 * num);
