...
namespace dev_toolkit.device
{
    public class dev_gnss
    {
        ...
        public void init(object sender)
        {
            ...
            _mag_calib = new mag_calib(
            _hander._mag_calib_page,
            _hander._mag_calib_groupControl);
            ...
            _mag_calib.trans_command += _hander._serial.command_trans;
        }
    }
}
