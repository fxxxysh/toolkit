    ...
    public class acc_calib
    {
        ...
        public void Initialize()
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                textEdit.Location = new Point(50 + loction_x + (loction_width * 3) * (i % 3), 22 + 2 * loction_height + i / 3 * loction_height);
                textEdit.Size = new Size(90, 20);
                textEdit.TabIndex = i;

                SimpleButton button = new SimpleButton();
                button.AllowFocus = false;
                button.Location = new Point(150 + loction_x + (loction_width * 3) * (i % 3), 20 + 2 * loction_height + i / 3 * loction_height);
                button.Size = new Size(80, 25);
                button.TabIndex = i;
                ...
                switch (i)
                {
                    ...
                    case 3: rotate_str = "X-"; break;
                    case 4: rotate_str = "Y-"; break;
                    case 5: rotate_str = "Z-"; break;
                }
